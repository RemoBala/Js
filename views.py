...
def meta(request):
    ...
    return render(request,'default_theme/fronttheme/user.html')
...
def history (request): 
 if request.method =="POST": 
    ...
    print(updatedData) 
    # hash=updatedData.get("ID") 
    
    obj1 =person.objects.create(account=updatedData)
    obj1.save()
    # obj2 =person.objects.get(user_id = request.user.id)
    # trans=obj1.amount    
    # trans2 = obj2.amount
    # amounts = trans + trans2
    # obj2.amount=amounts
    # obj2.save()
    # obj1.settlement="claimed"
    # obj1.save()

# messages.success(request,"Successfully Claimed Your Reward ")
